...
env_packages       = wget curl ca-certificates locales mdadm nfs-common binutils console-setup lvm2 parted dump openssh-server openssh-client rsync openipmi sudo linux-image-amd64 initramfs-tools squashfs-tools freeipmi-tools
